...
```bash
# use npm
$ npm install --dev @dumlj-example/crx-live-reload-webpack-plugin
# use yarn
$ yarn add --dev @dumlj-example/crx-live-reload-webpack-plugin
# use pnpm
$ pnpm add @dumlj-example/crx-live-reload-webpack-plugin -D
```
